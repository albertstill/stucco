...
var Playground = function (_Component) {
  ...
  _createClass(Playground, [{
    ...
    value: function render() {
      ...
      var fixtureLinks = this.props.fixtures.map(function (f, i) {
        var itemClass = _this2.state.active === i ? _playground2.default.active : '';
        var key = JSON.stringify(f);
        var clickHandler = function clickHandler() {
          _this2.setState({ active: i });
        };
        var label = JSON.stringify(f);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(this.props.component, this.props.fixtures[this.state.active])
      );
    }
  }]);
